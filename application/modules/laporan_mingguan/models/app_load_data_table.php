    ...
    public function dataCetakMingguanSatuKandang($id_lokasi, $kandang)
    {
        ...
        if ($id_lokasi == '' || $id_lokasi == null) {
            ...
            if ($kandang == '' || $kandang == null) {
                ...
                $output .= '
                <tr class="odd gradeX">
                                    <td class="text-center" colspan="2"> ' . $jumlah_data . ' data </td>
                                    <td class="text-center" style="width:10px">' . $total_mati_afkir_akhir . '</td>
                                    <td class="text-center" style="width:60px">' . round($total_ayam_akhir, 1) . '</td>
                                    <td class="text-center"> ' . round($butir_jumlah_akhir/$jumlah_data,2) . '</td>
                                    <td class="text-center"> ' . round($butir_kg_akhir/$jumlah_data,2) . '</td>
                                    <td class="text-center"> ' . round($pakan_kg_akhir/$jumlah_data,2) . '</td>
                                    <td class="text-center">' . round($hd_akhir / $jumlah_data, 2) . '</td>
                                    <td class="text-center">' . round($fcr_akhir/$jumlah_data, 2) . '</td>
                                    <td class="text-center"> ' . round($ew_akhir/$jumlah_data, 2) . ' </td>
                                    <td class="text-center">' . round($em_akhir/$jumlah_data,2) . '</td>

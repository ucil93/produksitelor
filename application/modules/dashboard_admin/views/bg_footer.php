            ...
            <div class="page-footer">
                ...
                <div class="page-footer-inner"> 
                    <?php echo $tahun; ?> &copy; Teknologi Informasi
                </div>
...
<![endif]-->
        ...
        <!-- SELESAI TAMBAHAN -->
        <!-- MULAI TAMBAHAN -->
        <script src="<?php echo base_url().'assets/pages/scripts/table-datatables-buttons-edited.min.js'; ?>" type="text/javascript"></script>
        <!-- SELESAI TAMBAHAN -->
        <!-- MULAI TAMBAHAN -->
        ...
        <script src="<?php echo base_url(); ?>assets/scripts/master_lokasi.js" type="text/javascript" ></script>
